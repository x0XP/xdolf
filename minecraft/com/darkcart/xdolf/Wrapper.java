...
public class Wrapper {
	...
	public static void addChatMessage(String s) {
		getPlayer().addChatMessage(new TextComponentString(Client.wrap(String.format("[%s%s%s] %s", "\247c", Client.CLIENT_NAME, "\247f", s), 100)));
	}
	...
	public static void onKeyPressed(int key, char character) {
		Hacks.onKeyPressed(key);
		CommandManager.onKeyPressed(key, character);
	}
}
