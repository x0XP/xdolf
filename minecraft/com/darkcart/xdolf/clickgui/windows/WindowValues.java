...
public class WindowValues extends XdolfWindow
{
	public WindowValues()
	{
		...
		addSlider(ElytraFly.elytraSpeed, 0.1F, 1.45F, false).setValue(1.41F);
		...
		addSlider(AutoFish.autocastDelay, 1, 60, true).setValue(5);
		addSlider(AutoFish.recastDelay, 10, 120, true).setValue(40);// Round to nearest 10 would be better
	}
}
