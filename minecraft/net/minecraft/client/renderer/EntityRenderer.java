...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (this.mc.gameSettings.viewBobbing && !Hacks.getMod(Tracers.class).isEnabled() && !Hacks.getMod(Waypoints.class).isEnabled() && !Hacks.getMod(Trajectories.class).isEnabled())
        {
